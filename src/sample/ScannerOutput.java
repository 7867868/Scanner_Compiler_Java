...
public class ScannerOutput implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        nonTokenNameColumn.setCellValueFactory(
                new PropertyValueFactory<NonToken, String>("name"));
        nonTokenValueColumn.setCellValueFactory(
                new PropertyValueFactory<NonToken, String>("value"));
        nonTokenTable.getItems().setAll(Controller.listNonToken);
        lblNonTokenTotal.setText("Total Non Tokens are "+Controller.listNonToken.size());
  ...
  /*  public ScannerOutput(){
        Label label=new Label("sdasdasd");
        label.setPrefSize(10,10);
         tokenTab.getChildren().add(label);
    }*/
}
